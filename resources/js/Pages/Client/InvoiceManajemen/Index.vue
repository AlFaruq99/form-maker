                ...
                <div class="grid grid-flow-row grid-cols-1 gap-6">
                    <ul class=" max-sm:hidden menu space-x-4 menu-horizontal rounded-md">
                        <li class="rounded-md text-neutral-900 bg-white shadow" :class="{
                            ...
                            <Link :href="route('client.invoice.clientIndex',{_query:{status:'belum_bayar'}})"> 
                        ...
                        <li class="rounded-md text-neutral-900 bg-white shadow" :class="{
                            ...
                            <Link :href="route('client.invoice.clientIndex',{_query:{status:'dp'}})">
                        ...
                        <li class="rounded-md text-neutral-900 bg-white shadow" :class="{
                            ...
                            <Link :href="route('client.invoice.clientIndex',{_query:{status:'lunas'}})">
                    ...
                    <InvoiceBelumLunas :user-id="userId" v-if="status.value == 'belum_bayar'"></InvoiceBelumLunas>
...
export default {
    components: {
        AuthenticatedLayout,Head,Link,InvoiceBelumLunas,InvoiceDP,InvoiceLunas
    },
    props:{
        status:String,
        userId:Number
    ...
    methods: {
        ...
        generatePdf() {
            try {
                const response = axios.get(route('client.invoice.stream',{
                }))
